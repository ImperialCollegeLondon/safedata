...
vignette: >
  %\VignetteIndexEntry{An overview of the safe_data package}
...
`safe_data` package enables researchers to quickly and easily interface with 
these datasets. 
...
The formatting details for each worksheet are described here: https://safe-dataset-checker.readthedocs.io/en/latest/data_format/overview/
...
Submitted datasets are validated using the Python program  (`safe_dataset_checker`)[https://github.com/ImperialCollegeLondon/safe_dataset_checker]. 
